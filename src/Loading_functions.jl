...
# #MANTLE DATABASE STIXRUDE 2024
    ...
    push!(dbte,Dict(    :composition=> "predefined",
                        ...
                        :comments   => "J-F Moyen",
                        :test       => 0,
                        :elements   => ["S","P2O5","Rb", "Ba", "Th", "U", "Nb", "Ta", "La", "Ce", "Pb", "Pr", "Sr", "Nd", "Zr", "Hf", "Sm", "Eu", "Gd", "Tb", "Dy", "Y", "Ho", "Er", "Tm", "Yb", "Lu", "V", "Sc"],
                        :μg_g        => round.([200.0,200.0,64.5373756, 499.0093971, 5.69152854, 1.064824497, 5.430265866, 0.722386615, 29.06202556, 53.78324684, 15.17205921, 5.797620808, 484.5753262, 20.54095673, 150.2402264, 3.95645511, 3.317738791, 0.961548784, 2.418869313, 0.315058021, 1.593968618, 7.459369222, 0.296925128, 0.799927928, 0.128677572, 0.713354049, 0.133287066, 39.87762745, 5.524762752],digits=2),
                        :μg_g2       => round.([200.0,200.0,64.5373756, 499.0093971, 5.69152854, 1.064824497, 5.430265866, 0.722386615, 29.06202556, 53.78324684, 15.17205921, 5.797620808, 484.5753262, 20.54095673, 150.2402264, 3.95645511, 3.317738791, 0.961548784, 2.418869313, 0.315058021, 1.593968618, 7.459369222, 0.296925128, 0.799927928, 0.128677572, 0.713354049, 0.133287066, 39.87762745, 5.524762752],digits=2),
                    ), cols=:union)
    ...
    push!(dbte,Dict(    :composition=> "predefined",
                        ...
                        :test       => 1,
                        :elements   => ["S","P2O5","Rb", "Ba", "Th", "U", "Nb", "Ta", "La", "Ce", "Pb", "Pr", "Sr", "Nd", "Zr", "Hf", "Sm", "Eu", "Gd", "Tb", "Dy", "Y", "Ho", "Er", "Tm", "Yb", "Lu", "V", "Sc"],
                        :μg_g        => round.([100.0,100.0,16.60777308, 122.8449739, 1.074692058, 0.290233271, 3.808354064, 0.330971265, 6.938172601, 16.04827796, 5.452969044, 2.253943183, 163.4533209, 10.18276823, 66.90677472, 1.841502082, 3.3471043, 0.915941652, 3.28230146, 1.417695298, 3.851230952, 20.74016207, 0.914966282, 2.20425, 0.343734976, 2.136202593, 0.323405135, 257.4346716, 38.23663423],digits=2),
                        :μg_g2       => round.([100.0,100.0,16.60777308, 122.8449739, 1.074692058, 0.290233271, 3.808354064, 0.330971265, 6.938172601, 16.04827796, 5.452969044, 2.253943183, 163.4533209, 10.18276823, 66.90677472, 1.841502082, 3.3471043, 0.915941652, 3.28230146, 1.417695298, 3.851230952, 20.74016207, 0.914966282, 2.20425, 0.343734976, 2.136202593, 0.323405135, 257.4346716, 38.23663423],digits=2),
                    ), cols=:union)
    ...
    push!(dbte,Dict(    :composition=> "predefined",
                        ...
                        :test       => 2,
                        :elements   => ["S","P2O5","Rb", "Ba", "Th", "U", "Nb", "Ta", "La", "Ce", "Pb", "Pr", "Sr", "Nd", "Zr", "Hf", "Sm", "Eu", "Gd", "Tb", "Dy", "Y", "Ho", "Er", "Tm", "Yb", "Lu", "V", "Sc"],
                        :μg_g        => round.([50.0,50.0,0.6,6.6,0.0795,0.0203,0.658,0.037,0.648,1.675,0.150,0.254,19.9,1.25,10.5,0.283,0.406,0.154,0.544,0.099,0.674,4.30,0.149,0.438,0.068,0.441,0.0675,8.2,16.2],digits=2),
                        :μg_g2       => round.([50.0,50.0,0.6,6.6,0.0795,0.0203,0.658,0.037,0.648,1.675,0.150,0.254,19.9,1.25,10.5,0.283,0.406,0.154,0.544,0.099,0.674,4.30,0.149,0.438,0.068,0.441,0.0675,8.2,16.2],digits=2),
                    ), cols=:union)
